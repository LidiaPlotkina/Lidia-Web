        ...
        <>
            <div className="container w-80 mx-auto my-3.5 bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transform hover:scale-125 duration-500">
                ...
                <div className="text-center relative py-14">
                    ...
                    <h1 className="mb-1 text-2xl font-sans font-semibold text-gray-700 hover:text-gray-900 cursor-pointer">{props.postHead}</h1>
                    <span className="text-lg text-gray-700 hover:text-gray-900">{ props.postDesc}</span>
                </div>
            </div>
        </>
    );
